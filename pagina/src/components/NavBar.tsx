...
function NavBar() {
  return (
    <nav className="fixed w-full bg-black p-4 flex   justify-between">
      ...
      <div className="flex justify-around w-1/6 bg-black">
      <button className="text-white">
        ...
        <button className="text-white"><svg className="w-[28px] h-[28px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
